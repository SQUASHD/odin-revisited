...
You can see the [original](https://odin.hjartland.dev/projects/old/landing-page), or have a look at [the repo](https://github.com/SQUASHD/landing_page).
...
No separate assignment, just spent time sprucing up the [landing page](https://odin.hjartland.dev).
